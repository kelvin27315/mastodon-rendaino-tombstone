...
# timeline取得 2回目
            [
                { 'id': 8, 'created_at': datetime(2017, 11, 4, 17, 29, 0, 0, UTC), 'content': 'ズズズ', 'account': { 'username': 'sakuya', 'display_name': '咲夜', } },
...
# BUG: 29:00.000を含めるかどうかがget_timelineとselect_tootsで一致していない
            [
                { 'id': 7, 'created_at': datetime(2017, 11, 4, 17, 29, 0, 0, UTC), 'content': 'ズズズ', 'account': { 'username': 'akyu', 'display_name': '阿求', } },
            ],
        ]
